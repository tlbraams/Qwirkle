...
public class NetworkGame implements Runnable {
	 ...
	 */
	public NetworkGame(/* @NonNull */int playerCount, /* @NonNull */NetworkPlayer[] players, 
			/* @NonNull */int thinkTime, /* @NonNull */GameHandler gameHandler) {
		board = new Board();
	 ...
	 */
	/*@ pure */public /*@ NonNull*/ int findMaxScore(/*@ NonNull*/HashSet<Piece> hand) {
		int max = 0;
		for (Piece p : hand) {
	 ...
	 */
	public /*@ NonNull */String[] place(/* @NonNul*/Move[] moves, /* @NonNul*/Player player) {
